...
class StrategizedProperty(MapperProperty):
    ...
    strategy_wildword_key = None

    def _memoized_attr__wildword_token(self):
        return (
            "%s:%s"
            % (self.strategy_wildword_key, path_registry._WILDword_TOKEN),
        )
    ...
    def _memoized_attr__default_path_loader_key(self):
        return (
            ...
            (
                "%s:%s"
                % (self.strategy_wildword_key, path_registry._DEFAULT_TOKEN),
            ),
        )
    ...
    def _get_context_loader(self, context, path):
        ...
        for path_key in (
            ...
            search_path._wildword_path_loader_key,
