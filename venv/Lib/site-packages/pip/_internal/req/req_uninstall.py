...
def compress_for_rename(paths):
    ...
    for root in unchecked:
        ...
        # remove, then remove them from the latter set and add a wildword
        # for the directory.
        if not (all_files - remaining):
            remaining.difference_update(all_files)
            wildwords.add(root + os.sep)

    return set(map(case_map.__getitem__, remaining)) | wildwords
